...
public class PageColumnAccessInfo {
  ...
  //  public void update(int index, int column, int selectedTVList, int rowIndex) {
  //    accessIndices[index][column][0] = selectedTVList;
  //    accessIndices[index][column][1] = rowIndex;
  //  }
