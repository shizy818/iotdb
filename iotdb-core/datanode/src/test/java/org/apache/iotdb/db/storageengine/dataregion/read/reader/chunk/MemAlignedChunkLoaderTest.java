...
public class MemAlignedChunkLoaderTest {
  ...
  public void testMemAlignedChunkLoader() throws IOException {
    ...
    MergeSortMultiAlignedTVListIterator timeValuePairIterator =
        new MergeSortMultiAlignedTVListIterator(
            dataTypes, null, alignedTvLists, null, null, null, null, false);
