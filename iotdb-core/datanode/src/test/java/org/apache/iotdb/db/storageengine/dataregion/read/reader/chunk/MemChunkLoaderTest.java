...
public class MemChunkLoaderTest {
  ...
  public void testBooleanMemChunkLoader() throws IOException {
    ...
    MultiTVListIterator timeValuePairIterator =
        new MergeSortMultiTVListIterator(booleanTvLists, null, null);
  ...
  public void testInt32MemChunkLoader() throws IOException {
    ...
    MultiTVListIterator timeValuePairIterator =
        new MergeSortMultiTVListIterator(int32TvLists, null, null);
    Mockito.when(chunk.getMultiTVListIterator()).thenReturn(timeValuePairIterator);
  ...
  public void testInt64MemChunkLoader() throws IOException {
    ...
    MultiTVListIterator timeValuePairIterator =
        new MergeSortMultiTVListIterator(int64TvLists, null, null);
    Mockito.when(chunk.getMultiTVListIterator()).thenReturn(timeValuePairIterator);
  ...
  public void testFloatMemChunkLoader() throws IOException {
    ...
    MultiTVListIterator timeValuePairIterator =
        new MergeSortMultiTVListIterator(floatTvLists, null, null);
    Mockito.when(chunk.getMultiTVListIterator()).thenReturn(timeValuePairIterator);
  ...
  public void testDoubleMemChunkLoader() throws IOException {
    ...
    MultiTVListIterator timeValuePairIterator =
        new MergeSortMultiTVListIterator(doubleTvLists, null, null);
    Mockito.when(chunk.getMultiTVListIterator()).thenReturn(timeValuePairIterator);
  ...
  public void testTextMemChunkLoader() throws IOException {
    ...
    MultiTVListIterator timeValuePairIterator =
        new MergeSortMultiTVListIterator(textTvLists, null, null);
    Mockito.when(chunk.getMultiTVListIterator()).thenReturn(timeValuePairIterator);
